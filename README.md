...
> [!WARNING]
> O suporte padrão do Windows 10 terminou em **14 de outubro de 2025**. Este script não substitui atualizações de segurança do sistema operacional.

## 🚀 Como usar

### 1. Baixe o arquivo principal

👉 **[OHenrique-Optimization-Windows-10.ps1](OHenrique-Optimization-Windows-10.ps1)**
